...
$url = 'http://job.dajie.com';
// get DOM from URL or file
$html = file_get_html($url);


$beijing = $html->find('div#show-110000 ul li');
$shanghai = $html->find('div#show-310000 ul li');
$guangzhou = $html->find('div#show-440000 ul li');

if(count($beijing)<40)
{
	echo 'job/index beijing job count lt 40';
	exit(2);
}
if(count($shanghai)<40)
{
	echo 'job/index shanghai job count lt 40';
	exit(2);
}
if(count($guangzhou)<40)
{
	echo 'job/index guangdong job count lt 40';
	exit(2);
}
echo 'ok';
exit(0);

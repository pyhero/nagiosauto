...
plugin="nagios-plugins-2.1.1"
file=$SRC/${plugin}.tar.gz
name=${plugin}.tar.gz
url="http://www.nagios-plugins.org/download/nagios-plugins-2.1.1.tar.gz"
download

cd $SRC && tar zxf $name > /dev/null && cd $plugin
